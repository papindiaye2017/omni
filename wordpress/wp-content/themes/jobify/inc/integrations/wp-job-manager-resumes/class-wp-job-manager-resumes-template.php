...
class Jobify_Job_Manager_Resumes_Template {
	...
	public function the_candidate_location( $location, $post ) {
		if ( 
			'' == jobify_theme_mod( 'resume-display-address-format' ) ||
	...
	public function address_formats( $formats ) {
		return array(
			'default' => jobify_theme_mod( 'resume-display-address-format' )
		);
	}
	...
	public function widgets_init() {
		...
		if ( 'side' == jobify_theme_mod( 'jobify_listings', 'jobify_listings_display_area' ) ) {
			...
			$columns = jobify_theme_mod( 'resume-display-sidebar-columns' );
