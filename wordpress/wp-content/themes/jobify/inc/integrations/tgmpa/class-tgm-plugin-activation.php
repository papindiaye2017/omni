...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function init() {
			...
			// Load class strings.
			$this->strings = array(
				'page_title'                      => __( 'Install Required Plugins', 'jobify' ),
				'menu_title'                      => __( 'Install Plugins', 'jobify' ),
				'installing'                      => __( 'Installing Plugin: %s', 'jobify' ),
				'oops'                            => __( 'Something went wrong with the plugin API.', 'jobify' ),
				...
				'return'                          => __( 'Return to Required Plugins Installer', 'jobify' ),
				'dashboard'                       => __( 'Return to the dashboard', 'jobify' ),
				'plugin_activated'                => __( 'Plugin activated successfully.', 'jobify' ),
				'activated_successfully'          => __( 'The following plugin was activated successfully:', 'jobify' ),
				'plugin_already_active'           => __( 'No action taken. Plugin %1$s was already active.', 'jobify' ),
				'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for this theme. Please update the plugin.', 'jobify' ),
				'complete'                        => __( 'All plugins installed and activated successfully. %1$s', 'jobify' ),
				'dismiss'                         => __( 'Dismiss this notice', 'jobify' ),
				'contact_admin'                   => __( 'Please contact the administrator of this site for help.', 'jobify' ),
			);
