...
class Jobify_Widgets {
    ...
    public function register_sidebars() {
        ...
        if ( ! ( jobify()->get( 'wp-job-manager-wc-paid-listings' ) || jobify()->get( 'restrict-content-pro' ) ) || apply_filters( 'jobify_legacy_price_table', false ) ) { require_once( trailingslashit( dirname( __FILE__ ) ) . '_widgets/class-widget-price-option.php' );
