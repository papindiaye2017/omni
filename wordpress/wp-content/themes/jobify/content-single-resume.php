...
$info            = jobify_theme_mod( 'resume-display-sidebar' );
...
<div class="page-header">
    ...
    <h3 class="page-subtitle">
        <ul>
            ...
            <li class="date-posted" itemprop="datePosted"><i class="icon-calendar"></i> <date><?php printf( __( 'Updated %s ago', 'jobify' ), human_time_diff( get_the_modified_time( 'U' ), current_time( 'timestamp' ) ) ); ?></date></li>
