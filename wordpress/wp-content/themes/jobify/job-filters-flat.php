...
<form class="job_search_form<?php if ( $is_flat ) : ?> job_search_form--flat<?php endif; ?>" action="<?php echo job_manager_get_permalink( 'jobs' ) ? job_manager_get_permalink( 'jobs' ) : get_post_type_archive_link( 'job_listing' ); ?>" method="GET">
	...
	<div class="search_jobs">
        ...
        <div class="search_categories">
            ...
            <?php job_manager_dropdown_categories( array( 'taxonomy' => 'job_listing_category', 'hierarchical' => 1, 'show_option_all' => __( 'Any category', 'jobify' ), 'name' => 'search_categories', 'orderby' => 'name', 'multiple' => false ) ); ?>
        </div>
